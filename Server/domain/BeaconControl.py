...
class BeaconControl:
    ...
    def new_beacon_detect(self, user_address, beacon_address):
        beacon_details = BeaconGateway.get_location_details(self, beacon_address)
        # add new beacon detection details to db
        StaffGateway.add_new_staff_location(self, user_address, beacon_details["beaconLevel"], beacon_details["beaconLocation"])